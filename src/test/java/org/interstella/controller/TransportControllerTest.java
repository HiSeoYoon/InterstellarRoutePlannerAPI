...
public class TransportControllerTest {
    ...
    @Test
    public void test_ValidInput() throws Exception {
    ...
    public void test_InvalidInput() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get("/transport/0.0") // distance is 0
                        .param("passengers", "0") // passengers are 0
                        .param("parking", "0") // parking is 0
                        .contentType(MediaType.APPLICATION_JSON))
